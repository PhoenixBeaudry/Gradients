...
CMD echo 'Preparing data...' && \
    ...
    accelerate launch --multi_gpu --mixed_precision bf16 --deepspeed_config_file /workspace/configs/deepspeed_stage2.json /workspace/training/train.py --config ${CONFIG_DIR}/${JOB_ID}.yml